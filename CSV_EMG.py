...
df = pd.read_csv("EMG_Data_18.csv")
df = df.to_numpy()
...
Gaussian_signal = gaussian_filter1d(e_bpf_EMG, 150)
...
print("Number of Contractions: " + str(len(peaks)))
...
plt.suptitle("Contractions: " + str(len(peaks)))
